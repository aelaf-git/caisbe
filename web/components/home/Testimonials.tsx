    ...
    <section className="border-b border-ifma-border-light bg-white py-16">
      <div className="mx-auto max-w-7xl px-4">
        <div className="mb-10 text-center">
          ...
          <h2 className="font-display text-caisbe-text-dark mt-3 text-3xl font-semibold md:text-4xl">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {testimonials.map((item) => (
            <blockquote
              key={item.name}
              className="shadow-brand-card rounded-lg border border-ifma-border-light border-l-4 border-l-caisbe-red bg-white p-8"
            >
